...
export const configVariables = {
  ...
  cache: {
    ...
    "redis-url": {
      type: "string",
      defaultValue: "redis://amen-redis:6379",
      secret: true,
    },
    ttl: {
      type: "number",
  ...
  email: {
    ...
    resetPasswordSubject: {
      type: "string",
      defaultValue: "amen Share password reset",
    },
    ...
    inviteSubject: {
      type: "string",
      defaultValue: "amen Share invite",
    },
    inviteMessage: {
      type: "text",
      defaultValue:
        'Hey!\n\nYou were invited to amen Share. Click this link to accept the invite: {url}\n\nYou can use the email "{email}" and the password "{password}" to sign in.\n\namen Share 🐧',
    },
  ...
  datasources: {
    db: {
      url:
        ...
        "file:../data/amen-share.db?connection_limit=1",
    },
  },
});
