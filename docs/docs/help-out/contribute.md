...
We would appreciate for you to contribute to amen Share X and help make it better! All contributions are welcome, including issues, suggestions, pull requests and more.
...
1. Create a fork of the repository by clicking on the `Fork` button in the amen Share repository

2. Clone your fork to your machine with `git clone`

```
git clone https://github.com/[your_username]/amen-share-x
```
...
amen Share consists of a frontend and a backend.
