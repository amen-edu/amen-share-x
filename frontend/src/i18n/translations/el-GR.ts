export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το amen Share στο δικό σας μηχάνημα.",
  ...
  "admin.config.config-file-warning.description": "As you have a configured amen Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το amen Share είναι διαθέσιμο",
  ...
  "admin.config.cache.redis-enabled.description": "Normally amen Share caches information in memory. If you run multiple instances of amen Share, you need to enable Redis caching to share the cache between the instances.",
