export default {
  ...
  "home.bullet.a.description": "Utrzymuj amen Share na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL amen Share jest dostępny",
