export default {
  ...
  "home.bullet.a.description": "Host amen Share on your own machine.",
  ...
  "admin.config.config-file-warning.description":
    "As you have a configured amen Share with a configuration file, you can't change the configuration through the UI.",
  ...
  "admin.config.general.app-url.description":
    "On which URL amen Share is available",
  ...
  "admin.config.cache.redis-enabled.description":
    "Normally amen Share caches information in memory. If you run multiple instances of amen Share, you need to enable Redis caching to share the cache between the instances.",
