export default {
  ...
  "home.bullet.a.description": "Configura amen Share sul tuo server.",
  ...
  "admin.config.config-file-warning.description": "Poiché hai configurato amen Share tramite un file di configurazione, non ti è possibile modificare la configurazione dall'interfaccia utente.",
  ...
  "admin.config.general.app-url.description": "Su quale URL amen Share è pubblicato",
  ...
  "admin.config.cache.redis-enabled.description": "Normalmente amen Share mantiene la cache in memoria. Se si eseguono più istanze di amen Share, è necessario abilitare il caching di Redis per condividere la cache tra le istanze.",
