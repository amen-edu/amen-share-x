export default {
  ...
  "home.bullet.a.description": "amen Share працює на вашій машині.",
  ...
  "admin.config.config-file-warning.description": "Оскільки у вас налаштовано amen Share за допомогою конфігураційного файлу, ви не можете змінювати конфігурацію через інтерфейс користувача.",
  ...
  "admin.config.general.app-url.description": "Адреса, на якій доступний amen Share",
