export default {
  ...
  "home.bullet.a.description": "A amen Share megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A amen Share megosztáskezelőre mutató hivatkozás",
