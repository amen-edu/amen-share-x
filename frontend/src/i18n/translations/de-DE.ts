export default {
  ...
  "home.bullet.a.description": "Betreibe amen Share auf deinem eigenen Server.",
  ...
  "admin.config.config-file-warning.description": "Da amen Share mit einer Konfigurationsdatei konfiguriert ist, kann die Konfiguration nicht über die Benutzeroberfläche geändert werden.",
  ...
  "admin.config.general.app-url.description": "Auf welcher URL amen Share verfügbar ist",
  ...
  "admin.config.cache.redis-enabled.description": "Normalerweise speichert amen Share Infos im Speicher. Wenn du mehrere Instanzen von amen Share laufen hast, musst du Redis Caching aktivieren, damit der Cache zwischen den Instanzen geteilt wird.",
