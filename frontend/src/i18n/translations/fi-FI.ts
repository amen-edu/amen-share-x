export default {
  ...
  "home.bullet.a.description": "Isännöi \"amen Share\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella amen Share on saatavilla",
