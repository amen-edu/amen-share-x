export default {
  ...
  "home.bullet.a.description": "Aloja amen Share en tu propio equipo.",
  ...
  "admin.config.config-file-warning.description": "Como tienes configurado amen Share con un archivo de configuración, no puedes cambiar la configuración a través de la interfaz gráfica.",
  ...
  "admin.config.general.app-url.description": "En cuál URL está disponible amen Share",
