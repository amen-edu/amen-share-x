export default {
  ...
  "home.bullet.a.description": "amen Share работает на вашей машине.",
  ...
  "admin.config.config-file-warning.description": "Поскольку у тебя настроен amen Share с помощью файла конфигурации, ты не можешь изменить настройки через интерфейс.",
  ...
  "admin.config.general.app-url.description": "Адрес на котором доступен amen Share",
  ...
  "admin.config.cache.redis-enabled.description": "Обычно amen Share кэширует информацию в памяти. Если у тебя запущено несколько экземпляров amen Share, тебе нужно включить кэширование Redis, чтобы кэш использовался совместно всеми экземплярами.",
