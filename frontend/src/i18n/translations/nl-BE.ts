export default {
  ...
  "home.bullet.a.description": "Host amen Share op uw eigen machine.",
  ...
  "admin.config.config-file-warning.description": "Aangezien je een geconfigureerde amen-share hebt met een configuratiebestand, kun je de configuratie niet via de gebruikersinterface wijzigen.",
  ...
  "admin.config.general.app-url.description": "De URL waar amen Share bereikbaar is",
  ...
  "admin.config.cache.redis-enabled.description": "Normaal gesproken slaat amen Share informatie op in het geheugen. Als u meerdere instanties van amen Share gebruikt, moet u Redis-caching inschakelen om de cache tussen de instanties te delen.",
