export default {
  ...
  "home.bullet.a.description": "Hébergez amen Share sur votre propre machine.",
  ...
  "admin.config.config-file-warning.description": "Puisque vous avez configuré amen Share avec un fichier de configuration, vous ne pouvez pas modifier la configuration via l'interface utilisateur.",
  ...
  "admin.config.general.app-url.description": "Depuis quel URL le partage amen est disponible",
  ...
  "admin.config.cache.redis-enabled.description": "Usuellement, amen Share conserve les informations en mémoire vive. Si vous exécutez plusieurs instances de amen Share, vous devez activer la mise en cache Redis pour partager le cache entre ces instances.",
