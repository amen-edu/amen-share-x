export default {
  ...
  "home.bullet.a.description": "amen Share'i kendi sunucunuzda barındırın.",
  ...
  "admin.config.config-file-warning.description": "amen Share'i bir yapılandırma dosyası ile kurduğunuz için, yapılandırmayı arayüz üzerinden değiştiremezsiniz.",
  ...
  "admin.config.general.app-url.description": "amen Share'in erişilebilir olduğu URL",
  ...
  "admin.config.cache.redis-enabled.description": "Normalde amen Share bilgileri bellekte önbellekler. Birden fazla amen Share örneği çalıştırıyorsanız, örnekler arasında önbelleği paylaşmak için Redis önbelleklemesini etkinleştirmeniz gerekir.",
