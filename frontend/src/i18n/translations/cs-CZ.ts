export default {
  ...
  "home.bullet.a.description": "Hostujte amen Share na svém vlastním počítači.",
  ...
  "admin.config.config-file-warning.description": "Jelikož je amen Share nastaven pomocí konfiguračního souboru, nemůžete změnit nastavení přes UI.",
  ...
  "admin.config.general.app-url.description": "Na kterém URL je amen Share k dispozici",
