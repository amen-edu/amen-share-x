export default {
  ...
  "home.bullet.a.description": "amen Shareをあなたのマシンでホストしましょう。",
  ...
  "admin.config.config-file-warning.description": "設定ファイル設定で済みのamen ShareはUI を使用して設定を変更することはできません。",
  ...
  "admin.config.general.app-url.description": "amen Shareで利用できるURL",
  ...
  "admin.config.cache.redis-enabled.description": "通常、amen Share は情報をメモリ内にキャッシュします。複数の amen Share インスタンスを実行する場合は、インスタンス間でキャッシュを共有するために Redis キャッシュを有効にする必要があります。",
