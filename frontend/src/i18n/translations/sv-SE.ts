export default {
  ...
  "home.bullet.a.description": "Hosta amen Share på din egen maskin.",
  ...
  "admin.config.config-file-warning.description": "Eftersom du har en konfigurerad amen Share med en konfigurationsfil kan du inte ändra konfigurationen genom UI.",
  ...
  "admin.config.general.app-url.description": "På vilken URL amen Share finns",
  ...
  "admin.config.cache.redis-enabled.description": "Normalt sett cachar amen Share information i minnet. Om du kör flera instanser av amen Share måste du aktivera Redis-cachning för att dela cachen mellan instanserna.",
