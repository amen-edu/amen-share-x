export default {
  ...
  "home.bullet.a.description": "Hostujte amen Share na svojoj mašini.",
  ...
  "admin.config.config-file-warning.description": "Pošto ste konfigurisali amen Share pomoću konfiguracionog fajla, ne možete menjati konfiguraciju putem korisničkog interfejsa (UI).",
  ...
  "admin.config.general.app-url.description": "Na kojoj URL adresi je dostupan amen Share",
  ...
  "admin.config.cache.redis-enabled.description": "amen Share obično kešira informacije u memoriji. Ako pokrećete više instanci amen Share-a, potrebno je da omogućite Redis keširanje kako bi se keš delio između instanci.",
